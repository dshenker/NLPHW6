...
As in previous homeworks, you should setup your conda environment for this homework using 

    conda env create -f environment.yml

and you can activate your environment anytime using 

    conda activate hw-tag
